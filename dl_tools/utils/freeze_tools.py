...
if __name__ == "__main__":
    keras_to_opencv("/media/anders/-Anders-5-/BluSense4/NN/Experiments/2020-11-01 17-49-28 - MobileNet_transferlearning_run1/checkpoint/best_epoch-00382_val-loss-0.00.hdf5")
