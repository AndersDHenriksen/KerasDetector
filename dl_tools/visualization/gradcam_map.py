...
class GradCAM:
	...
	def overlay_heatmap(self, heatmap, image, alpha=0.5,
		colormap=cv2.COLORMAP_PARULA):  #COLORMAP_VIRIDIS
...
if __name__ == "__main__":
	...
	# Get image
	DATA_FOLDER = r"D:\Data\2805 RMED Pre-project Droplet Detection Deep Learning\_Cutout\All"
	...
	orig = np.squeeze(image).astype(np.uint8)[:, :, ::-1]
